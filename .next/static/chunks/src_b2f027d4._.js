(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_b2f027d4._.js", {
...
function AuthProvider({ children }) {
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            const checkAuth = {
                "AuthProvider.useEffect.checkAuth": ()=>{
                    ...
                    const sessionCookie = document.cookie.split('; ').find({
                        "AuthProvider.useEffect.checkAuth.sessionCookie": (row)=>row.startsWith('session=')
                    }["AuthProvider.useEffect.checkAuth.sessionCookie"]);
    ...
    const login = async (username, password)=>{
        ...
        if (username === VALID_CREDENTIALS.username && password === VALID_CREDENTIALS.password) {
            ...
            document.cookie = 'session=true; path=/; max-age=86400'; // 1 día
...
_s(AuthProvider, "Qrx71DZmC5IY+44Ed9wnRa+5k5s=", false, function() {
    return [
...
function SiteHeader() {
    _s();
    const { logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$providers$2f$auth$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(SiteHeader, "JN45pPWTCN0QEZFRvGkjOxroHA0=", false, function() {
    return [
...
//# sourceMappingURL=src_b2f027d4._.js.map