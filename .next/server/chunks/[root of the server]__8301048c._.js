...
async function GET() {
    try {
        const items = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].inventoryItem.findMany({
            orderBy: {
                name: 'asc'
            }
        });
...
async function POST(request) {
    try {
        ...
        const newItem = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].inventoryItem.create({
            data: {
                name: data.name,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8301048c._.js.map